...
public class CLIParser implements Runnable, Cancellable {
	...
	public CLIParser(SimpleServentListener listener, PictureDrawWorker pictureDrawWorker, PingPongWorker pingPongWorker) {
		this.commandList = new ArrayList<>();
		
		commandList.add(new InfoCommand());
		commandList.add(new PauseCommand());
		commandList.add(new ResultCommand());
		commandList.add(new StopCommand(this, listener, pictureDrawWorker, pingPongWorker));
		commandList.add(new StartCommand(pictureDrawWorker));
		commandList.add(new StopDrawingCommand(pictureDrawWorker));
	}
