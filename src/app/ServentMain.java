...
public class ServentMain {
	...
	public static void main(String[] args) {
		...
		PingPongWorker pingPongWorker = new PingPongWorker();
		Thread pingPongThread = new Thread(pingPongWorker);
		pingPongThread.start();

		PictureDrawWorker pictureDrawWorker = new PictureDrawWorker();
		Thread drawThread = new Thread(pictureDrawWorker);
		drawThread.start();

		SimpleServentListener simpleListener = new SimpleServentListener(pictureDrawWorker);
		Thread listenerThread = new Thread(simpleListener);
		listenerThread.start();

		CLIParser cliParser = new CLIParser(simpleListener, pictureDrawWorker, pingPongWorker);
